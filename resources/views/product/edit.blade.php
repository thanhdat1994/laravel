    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('product.update', $product->id) }}" method="POST" class="form-horizontal justify-content-center align-items-center">
                    @method('PATCH')
                    @csrf
                    <div class="card-body col-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="inputNameProduct" placeholder="Name" value="{{ $product->name }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPrice" class="col-sm-4 col-form-label text-right">Price</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="currency" name="inputPrice" placeholder="Price" value="{{ number_format($product->price) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputNoteProduct" class="col-sm-4 col-form-label text-right">Note</label>
                            <div class="col-sm-8">
                                <textarea type="text" class="form-control" name="inputNoteProduct" placeholder="Note">{{ $product->note }}</textarea>
                            </div>
                        </div>
                    </div>
