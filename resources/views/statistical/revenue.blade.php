                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="input-group date">
                                <input type="text" id="datepicker-start" name="inputDateStart" value="{{Request::input('inputDateStart')}}" placeholder="Start date" class="form-control"/>
                                <label class="col-form-label">&nbsp;~&nbsp;</label>
                                <input type="text" id="datepicker-end" name="inputDateEnd" value="{{Request::input('inputDateEnd')}}" placeholder="End date" class="form-control"/>
                            </div>
                        </div>
                    </div>
                </div>
